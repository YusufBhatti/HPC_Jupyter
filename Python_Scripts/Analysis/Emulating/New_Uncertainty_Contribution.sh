...
VARIABLES=( CDNC_Filtered_OCI CDNC_Filtered_HARP )
VARIABLES=( ERF ERFaci ERFari  REFFL_CT_OCI CDNC_Filtered_OCI TAU355_daily AOD_Mode_1 SSA AI AOD_Mode_Coarse ) #ERF ERFaci ERFari )
...
#    srun --ntasks=1 --nodes=1 python -u Part_4_Emulated_New_Uncertainty_Contribution.py > log_Uncertainty_Contribution_${VARIABLE_NAME}_part4.out 2>&1 &
