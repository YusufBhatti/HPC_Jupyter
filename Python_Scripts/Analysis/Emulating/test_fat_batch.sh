...
export NUMBER_OF_SAMPLES=55000
...
VARIABLES=( CDNC_Filtered_OCI REFFL_CT_OCI CDNC_Filtered_SPEXone REFFL_CT_SPEXone CDNC_Filtered_HARP )
...
export NUMBER_OF_SAMPLES=2100000 # This is the number for how many emulated i want
export NUMBER_OF_SAMPLES_Newly_Generated=2100000 # This is the number for how many emulated i want


#python -u Generate_New_Samples_Constraints.py

export NUMBER_OF_SAMPLES=55000 # This is the masked number
#VARIABLES=(AOD TAU355 AAOD ANG AOD_Mode_1 AOD_Mode_2 AOD_Mode_3 SSA AI AOD_Mode_Coarse CDNC CDNC_Filtered REFFL_CT ERF ERFaci ERFari)
#MAX_PARALLEL=${VARIABLES[@]}
count=0
